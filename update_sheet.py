# update_sheet.py – FINAL AI Bro Scanner (150+ Stocks + NIFTY_50 Index)
import os
import json
import gspread
...
def update_google_sheet():
    logging.info("🚀 AI Bro Scanner – FINAL VERSION (150+ Stocks + NIFTY_50 Index)")
    try:
        ...
        header = [[f"📊 AI BRO SCANNER - {date_stamp} (FINAL VERSION)", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""]]
