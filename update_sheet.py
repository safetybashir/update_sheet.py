...
UNIVERSE = [
    ...
    'ASHOKLEY', 'CIPLA', 'TORNTPHARM', 'ETERNAL', 'TMPV',
    'WAAREEENER', 'MOTHERSON', 'GVT&D', 'CUMMINSIND', 'BEL',
    'EICHERMOT', 'DLF', 'ENRIN', 'BDL', 'SOLARINDS',
    'DMART', 'THERMAX', 'CGPOWER', 'LODHA', 'APOLLOHOSP',
    'NAUKRI', 'TVSMOTOR', 'TMCV', 'HEROMOTOCO', 'ABB',
    'ALKEM', 'SIEMENS', 'PERSISTENT', 'OFSS', 'SWIGGY',
    'LUPIN', 'JSWENERGY', 'INDUSTOWER', 'BOSCHLTD', 'BHARATFORG',
    'INDIGO', 'MARICO', 'DABUR', 'DIXON', 'SRF', 'MANKIND',
    'LTM', 'JINDALSTEL', 'HAVELLS', 'BAJAJ-AUTO', 'NYKAA',
    'COFORGE', 'TRENT', 'HINDPETRO', 'ASTRAL', 'POLYCAB',
    'MAZDOCK', 'PREMIERENE', 'APARINDS', 'GAIL', 'GODREJCP',
