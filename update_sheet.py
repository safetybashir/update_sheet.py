# update_sheet.py – AI Bro Scanner (Original 148+ Stocks + NIFTY Index + 15-Min Candle)
import os
import json
import gspread
...
UNIVERSE = [
    ...
    # --- 14 DIVERSIFIED STOCKS (ADDED) ---
    'TATACONSUM', 'HDFCBANK', 'ICICIBANK', 'SBIN', 'AXISBANK',
    'KOTAKBANK', 'INDUSINDBK', 'BAJFINANCE', 'HDFCLIFE', 'SBI LIFE',
    'ICICIPRUDI', 'ICICIGI', 'MUTHOOTFIN', 'CHOLAFIN'
]
